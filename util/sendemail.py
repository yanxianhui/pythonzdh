...
class Email:
    def __init__(self, server=None, sender=None, password=None, receiver=None, title=None, message=None, path=None):
        """初始化Email
    ...
    def send(self):
        ...
        try:
            ...
            self.logger.exception('发送邮件失败,无法连接到SMTP服务器，检查网络以及SMTP服务器. %s', e)
        else:
            try:
    ...
    def sendemail(self,pass_list,fail_list):
...
if __name__ == '__main__':
    EMD=Email()
    EMD.sendemail([1, 2, 3, 4], [2, 3, 4, 5, 6, 7])